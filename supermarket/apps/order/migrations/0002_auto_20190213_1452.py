# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-02-13 14:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True)),
                ('is_delete', models.BooleanField(default=False)),
                ('goods_sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods_sku', verbose_name='订单商品ID')),
